...
{
    public abstract class CatchableTextGameObject : TextGameObject, ICatchableGameObject
    {
        ...
        public CatchableTextGameObject() : this(null)
        {

        }

        public CatchableTextGameObject(string id) : base(id)
        {
